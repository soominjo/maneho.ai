...
- [ ] Grant `roles/iam.serviceAccountUser` on the specific _Runtime_ Service Account your function will run as.
...
_Goal: Build the tRPC API endpoints for all Epics and Killer Features._
...
_Goal: Build the user interfaces for the Epics and Killer Features using React and Shadcn UI._
